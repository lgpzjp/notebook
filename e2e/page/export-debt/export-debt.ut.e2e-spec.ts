...
import { ExportDebtTestData } from './export-debt.ut.test-data';
...
describe('export-debt', () => {
  ...
  it('モックの返却値をテストデータに変更', () => {
    CommonUtils.sendXhr('/cmnservice/api/v1/loginuseremployeebindmodel/change/mock', {
      resultList: ExportDebtTestData.LOGIN_USER_INFO,
      status: 200
    });
  ...
  describe('画面項目ケース', () => {
    ...
    describe('EL2-4-1-1', () => {
      it('No1-1 ラベルチェック\n' +
        '   1-1 「支払先コード」であること\n', () => {
          ...
          page.clickTab(3);
          expect(page.getLabelText(2)).toEqual('支払先コード');
        });
      it('No2 桁数チェック\n' +
        '  2-2 入力できること \n' +
        '  2-3 「1」が入力されること \n' +
    ...
    describe('EL2-4-2-1', () => {
      it('No1-1 ラベルチェック\n' +
        '   1-1 「支払先カナ」であること\n', () => {
          expect(page.getLabelText(4)).toEqual('支払先カナ');
        });
      it('No2 桁数チェック\n' +
        '  2-2 入力できること \n' +
        '  2-3 「1」が入力されること \n' +
