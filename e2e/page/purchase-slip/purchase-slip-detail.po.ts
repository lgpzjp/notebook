...
export class PurchaseSlipDetail {
  modal: ElementFinder;
  nameEleModal: string;
  ...
  salseOrganizationDiv: BlComboBox;
  salseSupplierDiv: BlComboBox;
  ...
  constructor(el: ElementFinder) {
    this.modal = el;
    this.targetPeriodDiv = new BlComboBox($('bl-select#targetPeriodPurchase'));
    this.exportInfoTypeDiv = new BlComboBox($('bl-select#exportInfoTypePurchase'));
    this.organizationDiv = new BlComboBox($('share-organization-combo-box#organizationPurchase'));
    this.salseOrganizationDiv = new BlComboBox($('bl-select#salseOrganizationPurchase'));
    this.salseSupplierDiv = new BlComboBox($('bl-select#salseSupplierPurchase'));
  }
  /**
   * 表示モードの確認
   */
   ...
   * @param nameOfClass
   */
  checkClass(nameOfClass: string) {
    this.modal.$$('.' + nameOfClass);
  }
