...
import { ExportDepositDivArray, ExportDepositTypeDiv, ExportOrderDiv, ExportOrderDivArray } from './export-glass-deposit.define';
...
import { IExportGlassDepositConditionInput } from './export-glass-deposit.define';
 ...
 */
@Component({
  selector: 'app-export-glass-deposit-panel',
  templateUrl: 'export-glass-deposit-panel.component.html',
  styleUrls: ['export-glass-deposit-panel.component.scss']
})
export class ExportGlassDepositPanelComponent extends AbstractExportPanel {
  ...
  /** 出力情報タブ区分 */
  exportInfoTabDiv = ExportInfoTabDiv.GlassDeposit;

  /** 出力情報区分 */
  exportInfoDiv = ExportInfoDiv.Deposit;

  /** 出力情報名称 */
  exportInfoName = ExportInfoDivMap[ExportInfoDiv.Deposit];

  /** 出力情報項目リスト */
  _exportInfoItems = ExportInfoDivArray.filter(info => info.value === ExportInfoDiv.Deposit);
  ...
  protected initCondition(): void {
    ...
    this._condition.exportInfoType = ExportDepositTypeDiv.Slip;
