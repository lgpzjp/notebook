...
import { ScreenService } from '@blcloud/bl-ng-share-module';
...
export class ExportReportPageComponent implements OnInit, OnDestroy {
  /** タイトル */
  _title = '帳票出力';
  ...
  constructor(
    ...
    private pageService: ExportReportPageService
  ) {}

  ngOnInit(): void {
    this.screenService.setTitle(this._title);
  ...
  private monitorRouterEvent() {
    this.subscription.add(
      this.route.url.subscribe(() => {
        ...
        allExportMenuItems$.subscribe((items) => {
